...
public class JsonStudentsTask3 {
    /**
     * Дана json строка (можно сохранить в файл и
     * читать из файла)
     * [{"фамилия":"Иванов","оценка":"5","предмет":
     * "Математика"},{"фамилия":"Петрова","оценка":"4",
     * "предмет":"Информатика"},{"фамилия":"Краснов",
    ...
    public static void main(String[] args) {
        String strjsn_offile = getLineOffile("seminar_homework/seminar2/Txt3.jsn");
    ...
    private static String[] gluing_strings(String[][] arraystr) {
        ...
        for (int i = 0; i < arraystr.length; i++) {
            ...
            Newstr.delete(0, Newstr.length()); // А здесь не понимаю, почему цикл не выводит остальные строки так же
        }
        return gluing_str;
    }
}
